...
public class CryptoUtil {
     ...
     * which is widely used for cryptographic operations and provides FIPS-approved
     * algorithms.
     * The FIPS (Federal Information Processing Standards) approved algorithms are
     * certified
     ...
     *
     * @param input
     *            the byte array to compute the hash value of
     * @return the computed hash value as a hexadecimal string
     * @throws IllegalStateException
     *             if the specified message digest algorithm is not available
     */
     ...
     *
     * @param block
     *            the Block object to compute the hash value of
     * @param <T>
     ...
     *
     * @param ecPrivate
     *            the private key to use for generating the signature
     * @param input
     *            the input data to sign
     * @return the generated signature as an array of bytes
     * @throws GeneralSecurityException
     *             if any security-related exceptions occur during the signature
     *             generation process
     */
     ...
     * @param input
     *            the input data to verify the signature of
     * @param encSignature
     *            the encrypted signature to be verified
