...
/**
 * The SignedVote class represents a signed vote cast by a player for a specific block in a blockchain.
 * It contains the vote and its corresponding signature.
 *
